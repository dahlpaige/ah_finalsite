...
function display_data() {
     ...
     echo "<div class='submitted'><h3><em>Thank you for filling out the form!<br />You submitted the following information:</em></h3></div><br />";
	
     foreach ($_POST as $key => $value) {
          echo "<div class='submitted'> $key : <strong> $value </strong></div><br /><br />";
